...
# Replace each body with the real LeRobot/SO-101 implementation.
...
class StepEvent:
    ...
    action: str
    timestamp: float
    gripper_state: str          # "open" | "closed" | "unknown"
    params_used: dict = field(default_factory=dict)


# ---------------------------------------------------------------------------
# Public API — stubs for Diya to implement
# ---------------------------------------------------------------------------
...
def record_skill(skill_name: str) -> None:
    ...
    # Example: use lerobot.record() with the SO-101 arm config.
    """
